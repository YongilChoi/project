...
/**
 * Plugin Name: direct send SMS
 * Plugin URI: http://www.sorynory.com/
 * Description: SMS plugin by directsend.co.kr gateway
 * Version: 1.0
 * Author: Yongil Choi
 * Author URI: http://www.sorynory.com
 */

add_action( 'the_content', 'my_thank_you_text2' );

function my_thank_you_text2 ( $content ) {
...
$receiver = '{"name":"허지영","mobile":"01074769732","note1":"","note2":"","note3":"","note4":"","note5":""}'
    .',{"name":"최용일2","mobile":"01097694876","note1":"다이렉트센드 2","note2":"다이렉트센드 3","note3":"다이렉트센드 4","note4":"다이렉트센드 5","note5":"다이렉트센드 6"}'
;
...
//$postvars = '{"username":"'.$username.'","key":"'.$key.'","reserve_no":"'.$reserve_no.'"}';        //JSON 데이터
